...
def main():
    ...
    processed_frame_queue = queue.Queue(maxsize=1000)
    ...
    # NotificationService
    notification_service = NotificationService('0.0.0.0.0', 80, 60000)

    # Laden der bekannten Gesichter
    face_loader = FaceLoader()

    # Frame Processor
    frame_processor = FrameProcessor(frame_queue, processed_frame_queue, face_loader, config_manager, notification_service)
